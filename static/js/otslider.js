...
function OTSlider(){
	...
	var OTSlider = {
		...
		setupNavs : function(){
			...
			pb.innerHTML = '<span class="ot-wrap-outer"><span class="ot-wrap-inner material-icons slider-prev-button">'+
			'file_download' +'</span></span>';
			
			nb = document.createElement("span");
			nb.className = "ot-next-button";
			nb.innerHTML = '<span class="ot-wrap-outer"><span class="ot-wrap-inner material-icons slider-next-button">'+
			'file_download' + '</span></span>';
